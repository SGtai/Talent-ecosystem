...
//↓↓↓↓↓↓↓↓↓↓请在这里配置您的基本信息↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓
	...
	public static String notify_url = "http://127.0.0.1:8080/talent/paymentUrlS";
//	http://127.0.0.1:8080/talent/   http://localhost:8080/paymentUr
	// 页面跳转同步通知页面路径 需http://格式的完整路径，不能加?id=123这类自定义参数，必须外网可以正常访问http://工程公网访问地址/alipay.trade.page.pay-JAVA-UTF-8/return_url.jsp
	public static String return_url = "http://127.0.0.1:8080/talent/paymentUrl";
