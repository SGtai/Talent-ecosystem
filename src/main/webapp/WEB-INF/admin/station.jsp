...
<div style="width: 80%;margin-top: 5%;margin-left: 10%">
    <div class="layui-form" >
        <div class="layui-form-item" style="margin-left: 5%">
            ...
            <button class="layui-btn" lay-submit lay-filter="searchStation"><i class="layui-icon">&#xe615;</i>搜索</button>
            <button style="margin-left: 5%" class="layui-btn layui-btn-normal" lay-filter="addStation"><i class="layui-icon">&#xe624;</i>添加岗位</button>
        </div>
    </div>
...
<script type="text/javascript">
    ...
    layui.use(['table','layer','jquery'], function(){
        ...
        table.render({
            elem: '#station'
            ,height: 312
            ,url: '/admin/station' //数据接口
            ,page: true //开启分页
            ,cols: [[ //表头
                {field: 'id', title: '序列',sort:true,width:100}
                ,{field: 'username', title: '类型名称'}
                ,{field: 'sex', title: '上一级', sort: true}
                ,{field: 'city', title: '操作'}
            ]]
        });
