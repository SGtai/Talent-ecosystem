...
<script type="text/html" id="chapter2">
	...
	<img src=<%=othPath+"sc.png"%> alt="" style="position: absolute;margin-left: 41%;margin-top: -20%;" id="sc3">
</script>
<script type="text/html" id="toolbar2">
	<%--	{{# if(d.astate == 0){  }}--%>
	<a class="layui-btn layui-btn-sm background-style" lay-event="video">添加视频</a>
...
<script>
	layui.use('table', function(){
		...
		table.render({
			...
			,height: 277
			,width: 1153
			,url: '<%=path+"chapter.data"%>' //数据接口
			,limit:5
			,page: true //开启分页
			,cols: [[ //表头
				{field: 'zjId', title: 'ID', width:80, sort: true, fixed: 'left'}
				,{field: 'zjName', title: '章节标题', width:180}
				,{field: 'msDescribe', title: '课程描述', width:237
				}
				,{field: 'zjPicture', title: '图片', width: 197, sort: true}
				,{field: 'kjId', title: '所属课程ID', width:167, sort: true}
